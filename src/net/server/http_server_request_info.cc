...
std::string HttpServerRequestInfo::GetHeaderValue(
  ...
  DCHECK_EQ(chromium::StringToLowerASCII(header_name), header_name);
...
bool HttpServerRequestInfo::HasHeaderValue(
  ...
  DCHECK_EQ(chromium::StringToLowerASCII(header_value), header_value);
  std::string complete_value = GetHeaderValue(header_name);
  chromium::StringToLowerASCII(&complete_value);
