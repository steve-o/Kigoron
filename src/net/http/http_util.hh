...
#ifndef NET_HTTP_HTTP_UTIL_HH_
#define NET_HTTP_HTTP_UTIL_HH_

#include <string>
#include <vector>

#include "chromium/strings/string_tokenizer.hh"
#include "net/http/http_byte_range.hh"
#include "net/http/http_version.hh"
#include "url/gurl.hh"
...
class HttpUtil {
 public:
  ...
  class HeadersIterator {
   ...
   private:
    chromium::StringTokenizer lines_;
  ...
  class ValuesIterator {
   ...
   private:
    chromium::StringTokenizer values_;
