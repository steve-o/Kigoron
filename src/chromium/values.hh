...
#ifndef CHROMIUM_VALUES_HH_
#define CHROMIUM_VALUES_HH_
...
// This file declares "using chromium::Value", etc. at the bottom, so that
// current code can use these classes without the chromium namespace. In
// new code, please always use chromium::Value, etc. or add your own
// "using" declaration.
...
class DictionaryValue : public Value
{
 public:
  ...
  bool GetDictionary(const std::string& path, const DictionaryValue** out_value) const;
  ...
  // be used as paths.
  bool GetWithoutPathExpansion(const std::string& key, const Value** out_value) const;
  bool GetWithoutPathExpansion(const std::string& key, Value** out_value);
  bool GetIntegerWithoutPathExpansion(const std::string& key, int* out_value) const;
  bool GetDoubleWithoutPathExpansion(const std::string& key, double* out_value) const;
  bool GetStringWithoutPathExpansion(const std::string& key, std::string* out_value) const;
  bool GetDictionaryWithoutPathExpansion(const std::string& key, const DictionaryValue** out_value) const;
  bool GetDictionaryWithoutPathExpansion(const std::string& key, DictionaryValue** out_value);
  bool GetListWithoutPathExpansion(const std::string& key, const ListValue** out_value) const;
  bool GetListWithoutPathExpansion(const std::string& key, ListValue** out_value);
...
// http://crbug.com/88666
using chromium::DictionaryValue;
using chromium::ListValue;
using chromium::StringValue;
using chromium::Value;

#endif  // CHROMIUM_VALUES_HH_
