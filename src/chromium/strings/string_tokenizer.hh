...
#ifndef CHROMIUM_STRINGS_STRING_TOKENIZER_HH_
#define CHROMIUM_STRINGS_STRING_TOKENIZER_HH_
...
class StringTokenizerT {
 public:
  ...
  chromium::StringPiece token_piece() const {
    return chromium::StringPiece(&*token_begin_,
...
#endif  // CHROMIUM_STRINGS_STRING_TOKENIZER_HH_
