...
#if !defined(_MSC_VER)
extern template class StringPieceDetail<std::string>;
extern template class StringPieceDetail<string16>;
#endif

void CopyToString(const StringPiece& self, std::string* target);
void AppendToString(const StringPiece& self, std::string* target);
StringPieceDetail<std::string>::size_type copy(
    const StringPiece& self,
    char* buf,
    StringPieceDetail<std::string>::size_type n,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find(
    const StringPiece& self,
    const StringPiece& s,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find(
    ...
    char c,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type rfind(
    const StringPiece& self,
    const StringPiece& s,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type rfind(
    ...
    char c,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_first_of(
    const StringPiece& self,
    const StringPiece& s,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_first_not_of(
    const StringPiece& self,
    const StringPiece& s,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_first_not_of(
    ...
    char c,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_last_of(
    const StringPiece& self,
    const StringPiece& s,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_last_of(
    ...
    char c,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_last_not_of(
    const StringPiece& self,
    const StringPiece& s,
    StringPieceDetail<std::string>::size_type pos);
StringPieceDetail<std::string>::size_type find_last_not_of(
...
template<>
struct hash<chromium::StringPiece> {
  std::size_t operator()(const chromium::StringPiece& sp) const {
    HASH_STRING_PIECE(chromium::StringPiece, sp);
  }
};

#elif defined(_MSC_VER)

inline size_t hash_value(const chromium::StringPiece& sp) {
  HASH_STRING_PIECE(chromium::StringPiece, sp);
}
