...
#ifndef CHROMIUM_TIME_TIME_HH_
#define CHROMIUM_TIME_TIME_HH_
...
class Time {
 public:
  ...
  static const int64_t kQPCOverflowThreshold = 0x8637BD05AF7;
#endif
