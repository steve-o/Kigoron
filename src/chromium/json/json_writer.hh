...
#ifndef CHROMIUM_JSON_JSON_WRITER_HH_
#define CHROMIUM_JSON_JSON_WRITER_HH_
...
class JSONWriter {
 ...
 private:
  explicit JSONWriter(bool escape, bool omit_binary_values,
...
#endif  // CHROMIUM_JSON_JSON_WRITER_HH_
